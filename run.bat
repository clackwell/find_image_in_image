...
java FindImageInImage test_image_sub.png
echo.
::java FindImageInImage --allowed-pixel-fails-percent=0.5 test_image_sub_1px_diff.png
::java FindImageInImage test_image_sub.png test_image.png
::java FindImageInImage test_image_sub.png test_image_sub.png
...
java FindImageInImage --threads=1 --allowed-pixel-color-difference=100 --allowed-pixel-fails-percent=10.5 test_image_sub.png
echo.

java FindImageInImage --allowed-pixel-color-difference=100 --allowed-pixel-fails-percent=10.5 test_image_sub.png
